...
- (void)animateQRLine {
    [UIView animateWithDuration:_qrLineAnimateDuration
                     animations:^{
                         CGRect rect            = self->_qrLineImageView.frame;
                         rect.origin.y          = self->_qrLineY;
                         self->_qrLineImageView.frame = rect;
                     } completion:^(BOOL finished) {
                         if (self->_qrLineY > _scaMaxBorder) {
                             self->_qrLineY = _transparentOriginY + jm_qr_scanLineOffY;
                         }
